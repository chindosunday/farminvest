<!DOCTYPE html>
<!-- saved from url=(0050)https://gambolthemes.net/workwise-new/sign-in.html -->
<html>
  <head>
    ...
    <form method="POST" action="{{ route('login') }}">
                      ...
                      <div class="row">
                        ...
                        <div class="col-lg-12 no-pdd">
                          ...
                          <div class="pt-3"> Don't have an account?  <a href="{{ route('register') }}">Sign up here</a></div>
                        </div>
                      ...
                      <ul>
                        <li>
                          <a
                            ...
                            title=""
                            class="fb"
                            ><i class="fa fa-facebook"></i>Login Via Google</a
                          >
                        </li>
                ...
                <li>
                <a
                href="https://gambolthemes.net/workwise-new/help-center.html"
                title=""
                >Help Center</a
                >
                </li>
                <li>
                <a
                href="https://gambolthemes.net/workwise-new/about.html"
                title=""
                >About</a
                >
                </li>
                ...
                <li>
                <a
                href="https://gambolthemes.net/workwise-new/forum.html"
                title=""
                >Forum</a
                >
                </li>
                ...
                <p><img src="copy-icon.png" alt="" />Copyright 2019</p>
                </div>
                </div>
                <!--footy-sec end-->
                </div>
